    ...
    <>
      <section className="gradient-bg min-h-screen flex items-center relative overflow-hidden bg-gray-900 ">
        <div className="absolute inset-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-white rounded-full opacity-50 floating-delayed"></div>
          <div className="absolute bottom-1/3 left-1/2 w-3 h-3 bg-white rounded-full opacity-60 floating"></div>
        </div>
      ...
      {/* Additional section for job categories or featured jobs can be added here */}
      <CategoriesShow />
      {/* End of section for job categories or featured jobs */}
      {/* Featured Opportunities Section */}
      <FeaturedOpportunities />
      {/* End of Featured Opportunities Section */}
      {/* Call to Action Section */}
      <GetStarted />
      {/* end to call to action section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 italic">
                The user experience is fantastic! The platform made it so easy
                to track my applications and communicate with recruiters. Highly
                recommend!
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600 italic">
                JobFlow&apos;s career advice and resources are top-notch. I
                improved my portfolio based on their feedback and got hired
                within a month!
              </p>
            </div>
          </div>
